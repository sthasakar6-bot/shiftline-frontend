export default {
  ...
  signup: {
    ...
    rolePlaceholder: "e.g. Owner, Manager, Director",
  ...
  companyDetails: {
    ...
    kvkNumber: "KVK number (Chamber of Commerce)",
    vatNumber: "BTW / VAT number",
    businessType: "Business type",
    businessTypePlaceholder: "BV, VOF, Eenmanszaak...",
    industry: "Industry",
    industryPlaceholder: "Retail, Hospitality, Logistics, Healthcare...",
    employeeCount: "Number of employees",
    companyContactTitle: "Company contact",
    ...
    city: "City",
    country: "Country",
    billingSameAsBusiness: "Billing address same as business address",
  ...
  profile: {
    ...
    deleteAccountHint: "Permanently deletes your account and personal data. This cannot be undone.",
    deleteAccountHintManager: "Permanently deletes your account. If you're the last manager, this deletes the entire company and everyone's data. This cannot be undone.",
